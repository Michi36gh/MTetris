...
// selbst hinzugefügt
    private double timeBetweenMoves = 1.0f;

    private double currentTimeBetweenMoves;
...
// ende
    ...
    private void HandleMoveInputs()
    {
        ...
        if (Input.GetKey(KeyCode.A)) {
            // davor war hier nur Move(Vector2Int.left);
            ...
            // davor war hier nur Move(Vector2Int.right);
            if (CheckCollisionBelow()){
                Lock();
            }
            else{
    ...
    private void Lock()
    {
        lockCount++;
        if (lockCount % 8 == 0){
            if (timeBetweenMoves < 0.3){
                timeBetweenMoves = timeBetweenMoves * 0.98;
            }
            else{
            timeBetweenMoves = timeBetweenMoves * 0.86;
